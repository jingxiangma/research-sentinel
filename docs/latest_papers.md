...
_Generated on 2026-03-30 — 28 paper(s) matched._

---

## 1. [Landau Analysis in the Grassmannian](http://arxiv.org/abs/2603.25454v1)

**Authors:** Benjamin Hollering, Elia Mazzucchelli, Matteo Parisi, Bernd Sturmfels  
...
## 2. [Bounds on the Mordell-Weil rank of elliptic fibrations](http://arxiv.org/abs/2603.24666v1)

**Authors:** Antonella Grassi, Rick Miranda, Kapil Paranjape, Vasudevan Srinivas, Timo Weigand  
...
## 3. [Gromov-Witten invariants and membrane indices of fivefolds via the topological vertex](http://arxiv.org/abs/2603.24256v1)

**Authors:** Yannik Schuler  
**Published:** 2026-03-25  
...
## 4. [Shifting local exponents of Picard-Fuchs operators](http://arxiv.org/abs/2603.22614v1)

**Authors:** Tymoteusz Chmiel  
...
## 5. [Orthosymplectic Chern-Simons Matter Theories: Global Forms, Dualities, and Vacua](http://arxiv.org/abs/2509.11733v3)

**Authors:** Fabio Marino, Sinan Moura Soysüren, Marcus Sperling  
...
## 6. [Non-Lorentzian Supergravity from Matrix Theory](http://arxiv.org/abs/2603.10278v2)
...
## 7. [EPW varieties as moduli spaces on ordinary GM surfaces and special GM threefolds](http://arxiv.org/abs/2512.13269v3)

**Authors:** Ziqi Liu, Shizhuo Zhang  
...
## 8. [SuperDP: Differential Privacy Refutation via Supermartingales](http://arxiv.org/abs/2603.26215v1)
...
## 9. ["Oops! ChatGPT is Temporarily Unavailable!": A Diary Study on Knowledge Workers' Experiences of LLM Withdrawal](http://arxiv.org/abs/2603.26099v1)
...
## 10. [ExVerus: Verus Proof Repair via Counterexample Reasoning](http://arxiv.org/abs/2603.25810v1)
...
## 11. [On the Formalization of Network Topology Matrices in HOL](http://arxiv.org/abs/2603.25682v1)

**Authors:** Kubra Aksoy, Adnan Rashid, Osman Hasan, Sofiene Tahar  
**Published:** 2026-03-26  
**Matched keywords:** `theorem proving`, `proof assistant`, `interactive theorem`, `formalization`, `Isabelle`
...
## 12. [UCAgent: An End-to-End Agent for Block-Level Functional Verification](http://arxiv.org/abs/2603.25768v1)
...
## 13. [A formalization of the Gelfond-Schneider theorem](http://arxiv.org/abs/2603.24823v1)

**Authors:** Michail Karatarakis, Freek Wiedijk  
**Published:** 2026-03-25  
**Matched keywords:** `proof assistant`, `formalization`, `Lean 4`
...
## 14. [Formal Semantics for Agentic Tool Protocols: A Process Calculus Approach](http://arxiv.org/abs/2603.24747v1)
...
## 15. [Intrinsically Correct Algorithms and Recursive Coalgebras](http://arxiv.org/abs/2512.10748v2)

**Authors:** Cass Alexandru, Henning Urbat, Thorsten Wißmann  
...
## 16. [Goedel-Code-Prover: Hierarchical Proof Search for Open State-of-the-Art Code Verification](http://arxiv.org/abs/2603.19329v2)
...
## 17. [Deontic Temporal Logic for Formal Verification of AI Ethics](http://arxiv.org/abs/2501.05765v4)

**Authors:** Priya T. V., Shrisha Rao  
**Published:** 2025-01-10  
**Matched keywords:** `formal verification`, `automated theorem`, `formalization`
...
## 18. [Draft-and-Prune: Improving the Reliability of Auto-formalization for Logical Reasoning](http://arxiv.org/abs/2603.17233v2)
...
## 19. [SciCoQA: Quality Assurance for Scientific Paper--Code Alignment](http://arxiv.org/abs/2601.12910v2)
...
## 20. [TrustGeoGen: Formal-Verified Data Engine for Trustworthy Multi-modal Geometric Problem Solving](http://arxiv.org/abs/2504.15780v3)
...
## 21. [Pursuit of Truth and Beauty in Lean 4: Formally Verified Theory of Grammars, Optimization, Matroids](http://arxiv.org/abs/2602.12891v3)
...
## 22. [From Prompts to Packets: A View from the Network on ChatGPT, Copilot, and Gemini](http://arxiv.org/abs/2510.11269v2)
...
## 23. [Agentified Assessment of Logical Reasoning Agents](http://arxiv.org/abs/2603.02788v3)
...
## 24. [A formalization of System I with type Top in Agda](http://arxiv.org/abs/2603.23652v1)

**Authors:** Agustín Séttimo, Cristian Sottile, Cecilia Manzino  
...
## 25. [Mapping the Challenges of HCI: An Application and Evaluation of ChatGPT for Mining Insights at Scale](http://arxiv.org/abs/2306.05036v5)
...
## 26. [Agentic AI-based Coverage Closure for Formal Verification](http://arxiv.org/abs/2603.03147v2)
...
## 27. [Exponential Family Discriminant Analysis: Generalizing LDA-Style Generative Classification to Non-Gaussian Models](http://arxiv.org/abs/2603.20655v2)
...
## 28. [Power-SMC: Low-Latency Sequence-Level Power Sampling for Training-Free LLM Reasoning](http://arxiv.org/abs/2602.10273v2)
