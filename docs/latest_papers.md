...
_Generated on 2026-07-03 — 43 paper(s) matched._

---

## 1. [Bridgeland-Enriques general K3 surfaces](http://arxiv.org/abs/2607.02281v1)
...
## 2. [$χ$-independence for K3-surfaces via $p$-adic integration](http://arxiv.org/abs/2607.01513v1)

**Authors:** Michael Groechenig, Dimitri Wyss, Paul Ziegler  
**Published:** 2026-07-01  
**Matched keywords:** `Moduli of sheaves`
...
## 3. [Fukaya categories of Coulomb branches as unique deformations](http://arxiv.org/abs/2607.00146v1)

**Authors:** Jasper van de Kreeke  
**Published:** 2026-06-30  
**Matched keywords:** `Fukaya categories`, `Coulomb branches`
...
## 4. [Half-BPS Boundaries and the RG-Wall of $\mathcal{N}=2$ $SU(N)$ SYM](http://arxiv.org/abs/2606.30731v1)

**Authors:** Riccardo Comi, Simone Rota  
...
## 5. [Virtual cycles of 3-term complexes and the Hilbert schemes of surfaces](http://arxiv.org/abs/2606.29542v1)

**Authors:** Emilio Dominguez, Amin Gholampour  
...
## 6. [Generalizing the interacting dilatonic ghost condensate as a dark energy model](http://arxiv.org/abs/2606.28288v1)
...
## 7. [The refined local Donaldson-Thomas theory of curves](http://arxiv.org/abs/2506.14359v3)

**Authors:** Sergej Monavari  
**Published:** 2025-06-17  
**Matched keywords:** `Donaldson-Thomas theory`, `Calabi-Yau threefolds`
...
## 8. [Virtual invariants from the non-associative Hilbert scheme](http://arxiv.org/abs/2512.11538v3)

**Authors:** Gergely Bérczi, Felix Minddal  
...
## 9. [Extendability of projective varieties via degeneration to ribbons with applications to Calabi-Yau threefolds](http://arxiv.org/abs/2409.03960v3)
...
## 10. [Derived category of moduli of pointed curves -- II](http://arxiv.org/abs/2002.02889v5)
...
## 13. [ADVENT: LLM-Driven Automatic Predicate Invention for ILP](http://arxiv.org/abs/2607.01585v1)
...
## 14. [Adoption and Impact of Command-Line AI Coding Agents: A Study of Microsoft's Early 2026 Rollout of Claude Code and GitHub Copilot CLI](http://arxiv.org/abs/2607.01418v1)
...
## 15. [Theoria: Rewrite-Acceptability Verification over Informal Reasoning States](http://arxiv.org/abs/2607.01223v2)

**Authors:** Michael Saldivar, Ben Slivinski  
**Published:** 2026-07-01  
**Matched keywords:** `formal proof`, `proof assistant`
...
## 16. [LRAT-Catcher: Importing SAT Solver Certificates into Lean4 by Reflection](http://arxiv.org/abs/2607.00815v1)

**Authors:** Stefan Szeider  
**Published:** 2026-07-01  
**Matched keywords:** `interactive theorem`, `Lean 4`, `Mathlib`
...
## 17. [Dive into Claude Code: The Design Space of Today's and Future AI Agent Systems](http://arxiv.org/abs/2604.14228v2)
...
## 18. [Translating Natural Language to Strategic Temporal Specifications via LLMs](http://arxiv.org/abs/2606.30441v2)
...
## 19. [Aria: An Agent For Retrieval and Iterative Auto-Formalization via Dependency Graph](http://arxiv.org/abs/2510.04520v2)

**Authors:** Hanyu Wang, Ruohan Xie, Yutong Wang, Guoxiong Gao, Xintao Yu, Bin Dong  
**Published:** 2025-10-06  
**Matched keywords:** `autoformalization`, `formalization`, `Mathlib`
...
## 20. [Formal Semantics for Agentic Tool Protocols: A Process Calculus Approach](http://arxiv.org/abs/2603.24747v3)
...
## 21. [A Rust-to-Lean Verification Pipeline with AI Provers: An Experience Report](http://arxiv.org/abs/2605.30106v2)

**Authors:** Natalia Klaus, Juan Conejero, Palina Tolmach  
**Published:** 2026-05-28  
**Matched keywords:** `formal verification`, `Lean 4`
...
## 22. [Beyond the Library: An Agentic Framework for Autoformalizing Research Mathematics](http://arxiv.org/abs/2606.31134v2)
...
## 23. [Working Paper: Towards a Category-theoretic Comparative Framework for Artificial General Intelligence](http://arxiv.org/abs/2603.28906v4)
...
## 24. [Structural Enforcement of Statistical Rigor in AI-Driven Discovery: A Functional Architecture](http://arxiv.org/abs/2511.06701v3)
...
## 25. [A Category Theory Account of AI Identity](http://arxiv.org/abs/2607.00220v1)
...
## 26. [PolicyGuard: From Organizational Policies to Neuro-SymbolicCompliance Review Engines](http://arxiv.org/abs/2606.32004v1)
...
## 27. [Nazrin: An Atomic Neural Proof Automation Tactic in Lean 4](http://arxiv.org/abs/2602.18767v3)

**Authors:** Leni Aniva, Iori Oikawa, David Dill, Clark Barrett  
**Published:** 2026-02-21  
**Matched keywords:** `theorem proving`, `proof assistant`, `Lean 4`, `Mathlib`
...
## 28. [A Computational Toolkit for Engagement and Scalable Assessment in a Large Logic Course](http://arxiv.org/abs/2606.02367v2)

**Authors:** Stephen M. Watt  
**Published:** 2026-06-01  
**Matched keywords:** `proof assistant`, `Coq`
...
## 29. [Labelled Sequent Calculi for Propositional Team Logics](http://arxiv.org/abs/2606.31860v1)

**Authors:** Fausto Barbero, Marianna Girlando, Valentin Müller, Fan Yang  
**Published:** 2026-06-30  
...
## 30. [Formally Solving Answer-Construction Problems in Lean](http://arxiv.org/abs/2505.18492v6)
...
## 31. [Polymorphism Meets DHOL](http://arxiv.org/abs/2605.00295v2)
...
## 32. [Beyond Compilation: Evaluating Faithful Natural-Language-to-Lean Statement Formalization](http://arxiv.org/abs/2606.31002v1)

**Authors:** Ke Zhang, Patricio Gallardo Candela, Sudhir Murthy, Yi Xie, Zhi Wang, Maziar Raissi  
**Published:** 2026-06-30  
**Matched keywords:** `proof search`, `formalization`, `Mathlib`
...
## 33. [Containment Verification: AI Safety Guarantees Independent of Alignment](http://arxiv.org/abs/2605.09045v2)
...
## 34. [A Lean 4 Formalization of Scott's \emph{Continuous Lattices} (1972)](http://arxiv.org/abs/2606.30782v1)

**Authors:** Lars Warren Ericson  
**Published:** 2026-06-29  
**Matched keywords:** `formalization`, `Lean 4`, `Mathlib`
...
## 35. [Transformer Architectures as Complete Bayes Processes: A Formal Proof in the Measure-Theoretic Kernel Framework](http://arxiv.org/abs/2606.30440v1)
...
## 36. [Security Engineering in IIIf, Part II -- Shadowing the IIIf](http://arxiv.org/abs/2412.10949v2)
...
## 37. [Discovering New Theorems via LLMs with In-Context Proof Learning in Lean](http://arxiv.org/abs/2509.14274v4)

**Authors:** Kazumi Kasaura, Naoto Onda, Yuta Oriike, Masaya Taniguchi, Akiyoshi Sannai, Sho Sonoda  
**Published:** 2025-09-16  
**Matched keywords:** `theorem proving`, `formal proof`, `Lean 4`, `neural theorem`, `verified proof`
...
## 38. [Kofola 1.0: A Modular Approach to ω-Regular Complementation and Inclusion Checking (Technical Report)](http://arxiv.org/abs/2605.15390v2)

**Authors:** Ondrej Alexaj, Vojtěch Havlena, Lukáš Holík, Ondřej Lengál, Yong Li, Nicolas Mazzocchi  
...
## 39. [From Coalgebraic Determinization to Belief Construction for Partial Observability](http://arxiv.org/abs/2604.25355v3)
...
## 40. [Toward Secure and Reliable PDDL Formalization of Large Language Models with Planner-in-the-Loop Feedback](http://arxiv.org/abs/2606.29700v1)
...
## 41. [A Machine-Verified Proof of a Quantum-Optimization Conjecture](http://arxiv.org/abs/2606.29687v1)

**Authors:** Uri Kol, Maor Ben-Shahar, Kfir Sulimany, Dirk Englund  
**Published:** 2026-06-29  
**Matched keywords:** `proof assistant`, `Lean 4`, `verified proof`
...
## 42. [ScAle: Attention Head Scaling as a Minimal Adapter for Spatial Reasoning in Vision Language Models](http://arxiv.org/abs/2606.29579v1)
...
## 43. [Faults in Our Formal Benchmarking: Dataset Defects and Evaluation Failures in Lean Theorem Proving](http://arxiv.org/abs/2606.29493v1)

**Authors:** Pawan Sasanka Ammanamanchi, Siddharth Bhat, Stella Biderman  
**Published:** 2026-06-28  
**Matched keywords:** `theorem proving`, `machine-checked proof`
