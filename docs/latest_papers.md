...
_Generated on 2026-04-14 — 25 paper(s) matched._

---

## 1. [Rationality and symmetry of stable pairs generating series of Fano 3-folds](http://arxiv.org/abs/2604.06023v1)

**Authors:** Ivan Karpov, Miguel Moreira  
...
## 2. [Stability conditions on a singular quadric threefold](http://arxiv.org/abs/2511.20164v2)

**Authors:** Tzu-Yang Chou  
**Published:** 2025-11-25  
**Matched keywords:** `Stability Condition`, `semiorthogonal decomposition`, `exceptional collection`, `Bridgeland stability`
...
## 3. [Generalized K-theoretic invariants and wall-crossing via non-abelian localization](http://arxiv.org/abs/2512.22360v2)
...
## 4. [The refined local Donaldson-Thomas theory of curves](http://arxiv.org/abs/2506.14359v2)
...
## 5. [Branes and Representations of DAHA $C^\vee C_1$: affine braid group action on category](http://arxiv.org/abs/2412.19647v3)
...
## 6. [A Deductive System for Contract Satisfaction Proofs](http://arxiv.org/abs/2604.09165v1)
...
## 7. [CORA: Conformal Risk-Controlled Agents for Safeguarded Mobile GUI Automation](http://arxiv.org/abs/2604.09155v1)
...
## 8. [Awakening the Sleeping Agent: Lean-Specific Agentic Data Reactivates General Tool Use in Goedel Prover](http://arxiv.org/abs/2604.08388v1)

**Authors:** Jui-Hui Chung, Hongzhou Lin, Lai Jiang, Shange Tang, Chi Jin  
**Published:** 2026-04-09  
**Matched keywords:** `Mathlib`
...
## 9. [When Equality Fails as a Rewrite Principle: Provenance and Definedness for Measurement-Bearing Expressions](http://arxiv.org/abs/2604.07626v1)
...
## 10. [Explorable Theorems: Making Written Theorems Explorable by Grounding Them in Formal Representations](http://arxiv.org/abs/2604.02598v2)
...
## 11. [Proving Circuit Functional Equivalence in Zero Knowledge](http://arxiv.org/abs/2601.11173v2)
...
## 12. [SuperDP: Differential Privacy Refutation via Supermartingales](http://arxiv.org/abs/2603.26215v2)
...
## 13. [Automatic Generation of Safety-compliant Linear Temporal Logic via Large Language Model: A Self-supervised Framework](http://arxiv.org/abs/2503.15840v3)
...
## 14. [The Defense Trilemma: Why Prompt Injection Defense Wrappers Fail?](http://arxiv.org/abs/2604.06436v2)
...
## 15. [PROMISE: Proof Automation as Structural Imitation of Human Reasoning](http://arxiv.org/abs/2604.05399v2)

**Authors:** Youngjoo Ahn, Sangyeop Yeo, Gijung Im, Jongmin Lee, Jinyoung Yeo, Jieung Kim  
**Published:** 2026-04-07  
**Matched keywords:** `theorem proving`, `formal verification`, `interactive theorem`
...
## 16. [The Orientation Boundary for Step-Duplicating Recursors: Mechanized Impossibility, Escape, and Certification](http://arxiv.org/abs/2512.00081v8)

**Authors:** Moses Rahnama  
**Published:** 2025-11-26  
**Matched keywords:** `Lean 4`

> We formalize the orientation boundary for step-duplicating recursors. At the schema level, no measure in twelve formalized direct classes can strictly orient the duplicating step uniformly. The blocked classes cover additive and transparent-compositional measures, six scalar growth families, and four tracked vector/pair families under explicit pump/growth hypotheses. Two structural results sharpen the barrier: a scalar-projection theorem for matrix barriers and a symbolic variable-condition barrier yielding a KBO-style impossibility corollary for the witness system. This gives the first mechanized object-level barrier theorem for a fixed terminating system and several direct measure classes, proved without reductions or undecidability arguments. All results are formalized in Lean 4.   The paper also isolates three escape routes inside the direct universe. It proves a transparency-essentiality theorem with a witness, a dependency-pair escape characterization, a generalized polynomial boundary isolating failure of frozen base dominance, an escape trichotomy, barrier-witness extractors, a coefficient-table classifier, ablations, and two SCC synchronization families extending to finite cyclic and raw-graph forms. Every successful orienter imports assumptions outside the barrier classes.   For KO7, the guarded fragment is certified for strong normalization, confluence, a normalizer, and decidable reachability. We prove a single-exponential SafeStepCtx length theorem with a matching lower family, a DM ordinal calibration at $ω^ω$, and a triple-lex image below $ω^ω\cdot 2$. For the full unguarded system we prove root termination by a nonlinear polynomial witness and a KO7-specialized MPO, lift to context-closed strong normalization, and connect Lean to TTT2/CeTA through a checked TPDB export, a verifier bridge, and a replay of the FAST certificate core.

---

## 17. [Iterative Formalization and Planning in Partially Observable Environments](http://arxiv.org/abs/2505.13126v3)
...
## 18. [Munkres' General Topology Autoformalized in Isabelle/HOL](http://arxiv.org/abs/2604.07455v1)

**Authors:** Dustin Bryant, Jonathan Julián Huerta y Munive, Cezary Kaliszyk, Josef Urban  
**Published:** 2026-04-08  
**Matched keywords:** `autoformalization`, `formalization`, `Isabelle`
...
## 19. [Working Paper: Towards a Category-theoretic Comparative Framework for Artificial General Intelligence](http://arxiv.org/abs/2603.28906v2)
...
## 20. [Broken by Default: A Formal Verification Study of Security Vulnerabilities in AI-Generated Code](http://arxiv.org/abs/2604.05292v2)
...
## 21. [Explainable AI needs formalization](http://arxiv.org/abs/2409.14590v6)
...
## 22. [ProofSketcher: Hybrid LLM + Lightweight Proof Checker for Reliable Math/Logic Reasoning](http://arxiv.org/abs/2604.06401v1)

**Authors:** Kranthi Kommuru, Kunal Khanvilkar, Gaurav Parekh  
**Published:** 2026-04-07  
**Matched keywords:** `interactive theorem`, `Coq`
...
## 23. [Semantically Reflected Programs](http://arxiv.org/abs/2509.03318v2)

**Authors:** Eduard Kamburjan, Vidar Norstein Klungre, Yuanwei Qu, Rudolf Schlatte, Egor V. Kostylev, Martin Giese, Einar Broch Johnsen  
...
## 24. [A Formal Security Framework for MCP-Based AI Agents: Threat Taxonomy, Verification Models, and Defense Mechanisms](http://arxiv.org/abs/2604.05969v1)
...
## 25. [Adversarial Robustness of Time-Series Classification for Crystal Collimator Alignment](http://arxiv.org/abs/2604.06289v1)
