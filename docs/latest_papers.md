...
_Generated on 2026-08-20 — 52 paper(s) matched._

---

## 1. [Elliptic spin Ruijsenaars-Schneider integrable models from 5d $\mathcal{N}=1$ gauge theories](http://arxiv.org/abs/2608.17837v1)
...
## 2. [Quantized Volume Comparison for Fano Manifolds, II](http://arxiv.org/abs/2608.17397v1)
...
## 3. [Nonadaptive Learning in Robust Nonlinear Output Regulation](http://arxiv.org/abs/2608.17262v1)
...
## 4. [An answer for a Mistretta-Stoppino's conjecture](http://arxiv.org/abs/2608.16809v1)
...
## 5. [The quantum Hikita conjecture via quasimaps](http://arxiv.org/abs/2608.16746v1)

**Authors:** Hunter Dinkins, Ivan Karpov, Vasily Krylov  
**Published:** 2026-08-17  
**Matched keywords:** `Coulomb branches`
...
## 6. [Gromov-Witten theory of abelian varieties in families and modular forms](http://arxiv.org/abs/2608.16737v1)
...
## 7. [Quantized Coulomb Branches of Separated Cotangent Type and Orthosymplectic Quivers](http://arxiv.org/abs/2608.16091v1)
...
## 8. [Stability conditions supported on Lefschetz classes](http://arxiv.org/abs/2608.16013v1)

**Authors:** Franco Giovenzana, Antonios-Alexandros Robotis, Franco Rota, Vanja Zuliani  
**Published:** 2026-08-17  
**Matched keywords:** `Stability Condition`
...
## 9. [Positive Singularities and Volumes in Scattering Amplitudes](http://arxiv.org/abs/2608.15606v1)

**Authors:** Elia Mazzucchelli  
**Published:** 2026-08-16  
**Matched keywords:** `Amplituhedron`
...
## 10. [A remark on the full support property](http://arxiv.org/abs/2608.14540v1)
...
## 11. [Hodge numbers for orbifolds of Calabi-Yau threefolds Fermat type and the Roan pairs](http://arxiv.org/abs/2607.13946v4)

**Authors:** Sergey Aleshin, Alexander Belavin, Gleb Koshevoy  
...
## 14. [Wall crossing, string networks and quantum toroidal algebras](http://arxiv.org/abs/2512.24988v2)
...
## 15. [Towards a T-dual Emergent Gravity](http://arxiv.org/abs/2102.03167v2)

**Authors:** Daniel Bermudez, Raju Roychowdhury  
...
## 16. [An adjunction criterion in almost-complex 4-manifolds](http://arxiv.org/abs/2107.10929v2)
...
## 17. [Global forms of $\mathcal{N}=4$ theories and non-minimal Seiberg-Witten solutions](http://arxiv.org/abs/2510.02055v2)

**Authors:** Robert Moscrop  
...
## 20. [Fortuity in the D1-D5 system](http://arxiv.org/abs/2501.05448v4)
...
## 21. [Explicit description of certain 3-point K-theoretic Gromov-Witten invariants for flag manifolds](http://arxiv.org/abs/2608.00359v2)

**Authors:** Satoshi Naito, Daisuke Sagaki  
...
## 22. [Continuum envelopes on Fargues-Fontaine curves and elliptic curves](http://arxiv.org/abs/2404.04551v2)

**Authors:** Heng Du, Qingyuan Jiang, Yucheng Liu  
...
## 23. [Quiver Schemes for Nongeneric Stability and Cornering](http://arxiv.org/abs/2505.12156v3)

**Authors:** Lukas Bertsch, Søren Gammelgaard  
...
## 24. [Pairwise Logical Selection of Enthymeme Completions under Semantic-Link Uncertainty](http://arxiv.org/abs/2608.18820v1)
...
## 25. [Decomposing Wrong-Consensus Agreement in LLM Self-Consistency: A GPT-4.1 Case Study](http://arxiv.org/abs/2608.18795v1)
...
## 26. [Budget-First Tariff Recommendation (BFTR): A Complete Algorithmic Framework for Telecom Plan Recommendation without Overcharging](http://arxiv.org/abs/2608.18723v1)
...
## 27. [Formal Verification of Romanov's Triplet Logic: A Verified Filter for Sliding-window 3-CNF with Application to Structured Formulas](http://arxiv.org/abs/2608.18445v1)

**Authors:** Dmitry V. Alexandrov  
**Published:** 2026-08-19  
**Matched keywords:** `formal verification`, `proof assistant`
...
## 28. [A Kernel-Checked Exclusion Certificate for Erdős Problem 647](http://arxiv.org/abs/2608.17880v1)
...
## 29. [Neuro-symbolic learning over OWL 2 DL via consequence-based compilation to differentiable circuits](http://arxiv.org/abs/2608.17741v1)
...
## 30. [NeuroAbs: A Neuro-Symbolic RTL Abstraction Framework for Property Checking Acceleration](http://arxiv.org/abs/2608.17304v1)
...
## 31. [Certified but Private: Scalable Zero-Knowledge Proofs for Neural Network Guarantees](http://arxiv.org/abs/2608.17070v1)
...
## 32. [ReasFlow: Assisting Reasoning-Centric Scientific Discovery in Applied Mathematics via a Knowledge-Based Multi-Agent System](http://arxiv.org/abs/2607.14178v3)
...
## 33. [LLM-Driven AutoML for Cross-Lingual Handwritten OCR: Closed-Loop Neural Architecture Search with GPT-5, GPT-4o, and Claude Sonnet 4](http://arxiv.org/abs/2607.15509v3)

**Authors:** Mobina Kashaniyan, Amirhossein Ghassemi, Nasser Mozayani  
**Published:** 2026-07-16  
**Matched keywords:** `GPT-4`, `Claude`
...
## 34. [Eigenius: A Typed Knowledge-Graph DBMS with Epistemic Stratification and Institution-Mediated Reasoning](http://arxiv.org/abs/2608.04457v2)
...
## 35. [LLM Enhancement with Domain Expert Mental Model to Reduce LLM Hallucination with Causal Prompt Engineering](http://arxiv.org/abs/2509.10818v2)
...
## 36. [FVSpec: Real-World Property-Based Tests as Lean Challenges](http://arxiv.org/abs/2606.01008v2)
...
## 37. [Aletheia: What Makes RLVR For Code Verifiers Tick?](http://arxiv.org/abs/2601.12186v4)
...
## 38. [Can LLMs Reason Like Automated Theorem Provers for Rust Verification? VCoT-Bench: Evaluating via Verification Chain of Thought](http://arxiv.org/abs/2603.18334v2)
...
## 39. [Large language models as synthetic clinical experts to inform longitudinal rare-disease modeling](http://arxiv.org/abs/2608.16507v1)
...
## 40. [OpenGPT-4o-Image: A Comprehensive Dataset for Advanced Image Generation and Editing](http://arxiv.org/abs/2509.24900v2)
...
## 41. [Internalized Truth in Reflective Grounded Arithmetic](http://arxiv.org/abs/2608.16140v1)

**Authors:** Bryan Ford  
**Published:** 2026-08-17  
**Matched keywords:** `proof search`, `Isabelle`, `verified proof`
...
## 42. [WitCert: Sound Runtime Risk Observability and Gating for KV-Cache Quantization](http://arxiv.org/abs/2607.28699v3)
...
## 43. [Pricing the Risk of Runtime Compression: Anytime-Valid Admission and a Served-Output Law for Compressed Serving State](http://arxiv.org/abs/2608.15810v1)
...
## 44. [Does the Proof Prove It That Way? Faithful Formalization of Elements Proofs](http://arxiv.org/abs/2608.15432v1)

**Authors:** Tadd Mao, Tianjun Zhong, Dhruva Arekar, Yuming Feng, One An, Jiani Huang, Xujie Si, Ziyang Li  
**Published:** 2026-08-15  
**Matched keywords:** `formal verification`, `formal proof`, `proof search`, `autoformalization`, `formalization`
...
## 45. [The Physical Cutoff Does Not Restore Homogenization: Phase-Dependent Burning in the Strain G-Equation](http://arxiv.org/abs/2608.15337v1)
...
## 46. [The Quality of Claude AI-authored Python Tests Is Not Weaker Than Human-authored Tests](http://arxiv.org/abs/2608.15188v1)
...
## 47. [MiniGPT-Reverse-Designing: Predicting Image Adjustments Utilizing MiniGPT-4](http://arxiv.org/abs/2406.00971v3)
...
## 48. [A Constant-Competitive Algorithm for Dynamic Mixture-of-Experts Serving](http://arxiv.org/abs/2608.16947v1)

**Authors:** Ian D'Ambrosio  
**Published:** 2026-08-15  
**Matched keywords:** `formal proof`, `Lean 4`
...
## 49. [Does a Tool Result Carry More Authority Than Plain Text? Three Prospective Studies of False-Claim Adoption in a Synthetic Assignment Task with Claude Opus 5](http://arxiv.org/abs/2608.14992v1)
...
## 50. [Topological Semantics for Scoped Computational Paths](http://arxiv.org/abs/2608.04228v2)
...
## 51. [Multimodal Logic Programming with Full Formulas](http://arxiv.org/abs/2608.14297v1)
...
## 52. [MathForm: Scaling Mathematical Autoformalization with Knowledge Retrieval and Verification-Guided Refinement](http://arxiv.org/abs/2608.14221v1)

**Authors:** Lushi Pu, Weiming Zhang, Xinheng Xie, Zixuan Fu, Bingxiang He, Hengyu Zhao, Hongya Lyu, Xin Li, Jie Zhou, Yudong Wang  
**Published:** 2026-08-14  
**Matched keywords:** `autoformalization`, `formalization`, `Lean 4`, `Mathlib`
